...
public class MySpringConfig{ //extends WebMvcConfigurerAdapter {
	 ...
	 * System.out.println("Data source created"); DriverManagerDataSource dataSource
	...
	/*
	 * @Bean public JdbcTemplate getJdbcTemplate() {
	 * System.out.println("JdbcTemplate created"); JdbcTemplate jdbcTemplate=new
    ...
    public ViewResolver getViewResolver(){
		System.out.println("in vewresolver");
